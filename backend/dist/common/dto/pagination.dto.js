...
exports.OrderFilterDto = exports.UserFilterDto = exports.ProductFilterDto = exports.SearchDto = exports.PaginationDto = void 0;
...
class ProductFilterDto extends SearchDto {
    minPrice;
    maxPrice;
    sortBy = 'newest';
    order = 'DESC';
...
class UserFilterDto extends SearchDto {
    role;
}
...
class OrderFilterDto extends SearchDto {
    status;
}
